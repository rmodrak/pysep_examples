...
if __name__=='__main__':
    ...
    path_data=    '2006-10-09T013528_NORTH_KOREA/SAC/*L?[ZRT].sac'
    path_weights= './mtuq_weights.dat'
    event_id=     '2006-10-09T013528'
    model=        'ak135'
    ...
    grid = FullMomentTensorGridSemiregular(
        npts_per_axis=10,
        magnitudes=[3.80,3.85,3.90,3.95])
    ...
    origin = Origin({
        'time': '2006-10-09T01:35:28.000000',
        'latitude': 41.2874,
        'longitude': 129.1083,
        'depth_in_m': 250.,
        })
